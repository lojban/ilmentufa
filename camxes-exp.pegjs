...
text = expr:(intro_null NAI_clause* text_part_2 (!text_1 joik_jek)? text_1? faho_clause EOF?) {return _node("text", expr);}

intro_null = expr:(initial_spaces? su_clause* intro_si_clause) {return _node("intro_null", expr);}

//// EXP-MODIF: brivla/cmevla merge
text_part_2 = expr:(indicators? free*) {return _node("text_part_2", expr);}
...
//// EXP-MODIF: Allowing empty prenexes.
...
//// EXP-MODIF: Handling of term absorbtion as selbri tcita
...
//;term = sumti / ( !gek (tag free*) (sumti / KU_clause? free*) ) / termset / NA_clause KU_clause free*
...
//// EXP-MODIF: brivla/cmevla merge; adding LOhOI
term_start = expr:(term_1 / LE_clause / LI_clause / LU_clause / LAhE_clause / quantifier term_start / gek sumti gik / FA_clause / tag term_start / LOhOI_clause) {return _node("term_start", expr);}
...
sumti_tail = expr:((sumti_6 relative_clauses?)? sumti_tail_1 / relative_clauses sumti_tail_1 / sumti sumti_tail_1 / gek_sentence) {return _node("sumti_tail", expr);}
...
relative_clauses = expr:(relative_clause ((ZIhE_clause / joik) free* relative_clause)* / gek relative_clauses gik relative_clauses) {return _node("relative_clauses", expr);}
...
selbri_relative_clauses = expr:(selbri_relative_clause ((ZIhE_clause / joik) free* selbri_relative_clause)* / gek selbri_relative_clauses gik selbri_relative_clauses) {return _node("selbri_relative_clauses", expr);}
...
//// EXP-MODIF
////mixed lerfu/namcu strings banned
...
guhek = expr:(guk SE_clause? joik_jek / SE_clause? GUhA_clause free*) {return _node("guhek", expr);}
...
free = expr:(SEI_clause free* (terms CU_elidible free*)? selbri SEhU_elidible / vocative relative_clauses? selbri relative_clauses? DOhU_elidible / vocative sumti? DOhU_elidible / mex_2 MAI_clause free* / TO_clause text TOI_elidible / xi_clause / LOhAI_clause) {return _node("free", expr);}
...
//// EXP: Disallowing indicators to attach to LU directly:
// LU_post = post_clause
...
NOhOI_clause = expr:(NOhOI_pre NOhOI_post) {return _node("NOhOI_clause", expr);}
NOhOI_pre = expr:(pre_clause NOhOI spaces?) {return _node("NOhOI_pre", expr);}
NOhOI_post = expr:(post_clause) {return _node("NOhOI_post", expr);}

KUhOI_clause = expr:(KUhOI_pre KUhOI_post) {return _node("KUhOI_clause", expr);}
KUhOI_pre = expr:(pre_clause KUhOI spaces?) {return _node("KUhOI_pre", expr);}
KUhOI_post = expr:(post_clause) {return _node("KUhOI_post", expr);}
...
//// EXP-MODIF: brivla/cmevla merge
BRIVLA = expr:(gismu / lujvo / fuhivla / CMEVLA) {return _node("BRIVLA", expr);}
...
zoi_word = expr:((non_space+) spaces) !{ return _is_zoi_delim(expr); } { return ["zoi_word", join_expr(expr)]; }
...
brivla = expr:(!cmavo !slihykru initial_rafsi* brivla_core) {return _node("brivla", expr);}
...
initial_rafsi = expr:(extended_rafsi / y_rafsi / !any_fuhivla_rafsi y_less_rafsi !any_fuhivla_rafsi) {return _node("initial_rafsi", expr);}

//___________________________________________________________________

any_fuhivla_rafsi = expr:(fuhivla / fuhivla_rafsi / stressed_fuhivla_rafsi) {return _node("any_fuhivla_rafsi", expr);}

fuhivla = expr:(fuhivla_head stressed_syllable consonantal_syllable* final_syllable) {return _node("fuhivla", expr);}

stressed_extended_rafsi = expr:(stressed_hy_rafsi / stressed_fuhivla_rafsi) {return _node("stressed_extended_rafsi", expr);}

extended_rafsi = expr:(hy_rafsi / fuhivla_rafsi) {return _node("extended_rafsi", expr);}

stressed_fuhivla_rafsi = expr:(fuhivla_head stressed_syllable consonantal_syllable* onset y) {return _node("stressed_fuhivla_rafsi", expr);}

fuhivla_rafsi = expr:(&unstressed_syllable fuhivla_head onset y h?) {return _node("fuhivla_rafsi", expr);}
...
slihykru = expr:((CCV_rafsi / stressed_CCV_rafsi) h y onset) {return _node("slihykru", expr);}
...
hy_rafsi = expr:((long_rafsi unstressed_vowel / CCV_rafsi / CVV_rafsi) h y h?) {return _node("hy_rafsi", expr);}
...
glide = expr:((i / u) &nucleus !glide) {return _node("glide", expr);}

diphthong = expr:((a u !u / (a i / e i / o i) !i) !nucleus) {return _node("diphthong", expr);}
...
BAI = expr:(&cmavo ( k o h a u / k a h a i / d u h o / s i h u / z a u / k i h i / d u h i / c u h u / t u h i / t i h u / d i h o / j i h u / r i h a / n i h i / m u h i / k i h u / v a h u / k o i / c a h i / t a h i / p u h e / j a h i / k a i / b a i / f i h e / d e h i / c i h o / m a u / m u h u / r i h i / r a h i / k a h a / p a h u / p a h a / l e h a / k u h u / t a i / b a u / m a h i / c i h e / f a u / p o h i / c a u / m a h e / c i h u / r a h a / p u h a / l i h e / l a h u / b a h i / k a h i / s a u / f a h e / b e h i / t i h i / j a h e / g a h a / v a h o / j i h o / m e h a / d o h e / j i h e / p i h o / g a u / z u h e / m e h e / r a i ) &post_word) {return _node("BAI", expr);}
...
BY = expr:(&cmavo (ybu / j o h o / r u h o / g e h o / j e h o / l o h a / n a h a / s e h e / t o h a / g a h e / y h y / b y / c y / d y / f y / g y / j y / k y / l y / m y / n y / p y / r y / s y / t y / v y / x y / z y / u y / i y ) &post_word) {return _node("BY", expr);}
...
COI = expr:(&cmavo ( d i h a i / c o h o i / k i h a i / s a h e i / j u h i / c o i / f i h i / t a h a / m u h o / f e h o / c o h o / p e h u / k e h o / n u h e / r e h i / b e h e / j e h e / m i h e / k i h e / v i h o ) &post_word) {return _node("COI", expr);}
...
LE = expr:(&cmavo ( m e h e i / l e i / l o i / l e h i / l o h i / l e h e / l o h e / l o / l e / l a i / l a h i / l a ) &post_word) {return _node("LE", expr);}
...
//// EXP-ADD: na'ei
NAhE = expr:(&cmavo ( n a h e i / t o h e / j e h a / n a h e / n o h e ) &post_word) {return _node("NAhE", expr);}
...
SE = expr:(&cmavo ( s e / t e / v e / x e / t o h a i / v o h a i / x o h a i / s u h e i / s u h a i ) &post_word) {return _node("SE", expr);}
...
SOI = expr:(&cmavo ( s o i / x o i / f i h o i ) &post_word) {return _node("SOI", expr);}

//exp. grammar: move {li'o} to SA
SU = expr:(&cmavo ( s u / l i h o i ) &post_word) {return _node("SU", expr);}
...
UI = expr:(&cmavo ( k o h o i / s i h a u / o h a i / x e h e / x o h o / i h a / i e / a h e / u h i / i h o / i h e / a h a / i a / o h i / o h e / e h e / o i / u o / e h i / u h o / a u / u a / a h i / i h u / i i / u h a / u i / a h o / a i / a h u / i u / e i / o h o / e h a / u u / o h a / o h u / u h u / e h o / i o / e h u / u e / i h i / u h e / b a h a / j a h o / c a h e / s u h a / t i h e / k a h u / s e h o / z a h a / p e h i / r u h a / j u h a / t a h o / r a h u / l i h a / b a h u / m u h a / d o h a / t o h u / v a h i / p a h e / z u h u / s a h e / l a h a / k e h u / s a h u / d a h i / j e h u / s a h a / k a u / t a h u / n a h i / j o h a / b i h u / l i h o / p a u / m i h u / k u h i / j i h a / s i h a / p o h o / p e h a / r o h i / r o h e / r o h o / r o h u / r o h a / r e h e / l e h o / j u h o / f u h i / d a i / g a h i / z o h o / b e h u / r i h e / s e h i / s e h a / v u h e / k i h a / x u / g e h e / b u h o ) &post_word) {return _node("UI", expr);}
...
NOhOI = expr:(&cmavo ( n o h o i / p o h o i ) &post_word) {return _node("NOhOI", expr);}
